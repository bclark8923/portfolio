(function() {
  ...
  var d = new Date()
  document.getElementById("footer").innerHTML = document.getElementById("footer").innerHTML + " " + d.getFullYear() + " &nbsp;| &nbsp;<a style=\"color: white;\" href=\"mailto:brian@laurenceclark.com\">brian@laurenceclark.com</a>";
